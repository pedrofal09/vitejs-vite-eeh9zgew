...
const BLOCK_B = [
  { name: "Sentadilla (GATE médico — variante según clearance)", sets: 3, reps: "PRE 8-12 · POST 6", tempo: "RIR ≥3 pre-clearance", rest: "120", yt: "goblet squat to box form", notes: "GATE DURO. SIN clearance de fisio (DRA) ni cardiovascular → GOBLET o sentadilla a CAJA, ligera, exhalando, sin doming, RIR≥3. CON clearance + pines de seguridad físicamente instalados y probados → recién ahí sentadilla cargada. El patrón sentadilla queda como DEUDA pendiente de clearance, no como fallo del plan." },
  { name: "Extensión de Rodilla (cuádriceps) en multifuncional", sets: 3, reps: "12-15", tempo: "RIR 1-2", rest: "75", yt: "leg extension machine form", notes: "CUÁDRICEPS = el eslabón MÁS FRÁGIL de la masa magra bajo el gate: monoarticular, SIN carga axial, baja presión intraabdominal, DRA/CV-safe. 2ª frecuencia el jueves. Llévalo cerca del fallo real con reps altas (baja carga al fallo ≈ alta carga para hipertrofia)." },
  { name: "Jalón al Pecho + Remo en Polea (superserie)", sets: 4, reps: "8-12", tempo: "RIR 1-2", rest: "90", yt: "lat pulldown seated cable row form", notes: "2ª frecuencia de tracción de la semana. Retracción escapular, codos pegados. Estaciones distintas." },
  { name: "Press Banca con Mancuernas", sets: 3, reps: "8-12", tempo: "RIR 2", rest: "90", yt: "dumbbell bench press flat form", notes: "MANCUERNAS a propósito: se pueden soltar al fallar. NUNCA press de banca con barra libre en solitario sin pines de seguridad ni ayudante." },
  { name: "Hip Thrust a 1 pierna (o bipodal con pausa)", sets: 3, reps: "8-12", tempo: "Pausa arriba", rest: "90", yt: "single leg hip thrust form", notes: "Cadena posterior segura. NO peso muerto. Sin apnea. TECHO RIR≥2-3 y chequeo de coning/doming en CADA serie (DRA no valorada por fisio); si aparece abombamiento, pesadez pélvica o escape, baja carga o suspende." },
