...
// Meta aeróbica: 10K — 2 carreras/sem (Mié corta noche + Dom tirada mañana con RESET 30-35' y rampa ≤10%/sem). Bici = alternativa del Mié (calle, con luces) y del Lun (recuperación).
...
// BLOQUE A — MARTES noche (≤60'): Full-Body Superior + Bisagra + Brazos — OBLIGATORIA
const BLOCK_A = [
  { name: "Press de Pecho en Multiestación", sets: 4, reps: "8-10", tempo: "RIR 2", rest: "75", yt: "seated cable chest press machine form", notes: "SUPERSERIE A1 con Jalón al Pecho (estaciones distintas). Sentado, espalda y cabeza pegadas al respaldo, costillas abajo, exhala al empujar, cero apnea. Test del habla (sin clearance CV): si al cerrar la pareja no podés hablar en frases completas, alargá a 90s o pasá a series simples." },
  { name: "Jalón al Pecho en Polea Alta (agarre ancho prono)", sets: 4, reps: "8-10", tempo: "RIR 2", rest: "75", yt: "wide grip lat pulldown proper form", notes: "SUPERSERIE A2 con Press de Pecho. Agarre ancho prono HOY (el sábado va la barra Z supina en la superserie — estímulos distintos sin agregar ejercicios). Retracción escapular, barra a la clavícula exhalando, torso casi vertical (reclinación máx 15°): reclinarse para arrancar las últimas reps es extensión lumbar cargada (gate DRA). Si aparece doming, baja 1-2 placas." },
  { name: "Press Militar Sentado Mancuernas (respaldo 85-90°)", sets: 3, reps: "8-10", tempo: "RIR 2", rest: "90", yt: "seated dumbbell shoulder press back support", notes: "SUPERSERIE B1 con Remo en Polea. SIEMPRE sentado con respaldo alto (gate DRA: de pie multiplica la presión intraabdominal y tienta el Valsalva). Sube las mancuernas con impulso de rodillas (kick-up), no arqueando la lumbar; exhala al empujar, RIR 2 estricto. 1ª exposición vertical de la semana (la 2ª es el sábado, inclinado a 70-75°)." },
  ...
  { name: "Hip Thrust con Mancuerna/KB en Cadera (2 piernas)", sets: 3, reps: "10-12", tempo: "Pausa 2s · RIR 3", rest: "75", yt: "dumbbell hip thrust on bench form", notes: "Ya no es solo ligero: mancuerna o kettlebell sobre la cadera con progresión — única sobrecarga de cadena posterior SIN bisagra cargada (peso muerto sigue PROHIBIDO por DRA). Exhala al subir, pausa arriba SIN apnea, chequeo de coning por serie; abombamiento o pesadez pélvica → suspender. RIR 3 y énfasis concéntrico: las piernas llegan frescas a la carrera del miércoles. MÍNIMA VIABLE si el tiempo aprieta: Press de Pecho + Jalón + Dead Bug (20-25 min) — cuenta como cumplido." },
  { name: "Superserie: Curl Barra Z ⇄ Tríceps Cuerda (polea)", sets: 2, reps: "10-12 c/u", tempo: "RIR 2", rest: "60", yt: "ez bar cable curl and rope pushdown superset", notes: "Brazos DIRECTOS (faltaban en el plan): curl con barra Z en polea baja y extensión de tríceps con cuerda, espalda con espalda, 60s al cerrar la pareja. RIR 2, exhala en el esfuerzo, codos pegados al torso, cero balanceo. 1ª exposición semanal de brazos (la 2ª, con predicador y laterales, es el sábado). Si el reloj no da: 1 ronda y listo — este par es el único recorte permitido del martes." }
];

// BLOQUE B — JUEVES noche (≤60'): PIERNA — al cerrar: cena normal e INYECCIÓN al acostarse — OBLIGATORIA
const BLOCK_B = [
  { name: "Sentadilla — Goblet/Caja o Barra LIGERA (15-20 kg)", sets: 3, reps: "PRE 8-12 · POST 6", tempo: "RIR ≥3 pre-clearance", rest: "120", yt: "goblet box squat and light barbell squat form", notes: "Tolerás bien la barra LIGERA (15-20 kg): permitida A ESA CARGA, RIR ≥3, exhalando al subir, SIN Valsalva, con chequeo de coning/doming y pesadez pélvica en CADA serie — si aparece cualquiera, volvé al goblet (front-load = más suave para la línea alba). A 15-20 kg podés salir del movimiento cuando quieras (mismo tier que el goblet). Alternativas equivalentes: goblet con KB por los cuernos, o sentadilla a caja. VETO QUE SIGUE: pasar de ~20 kg exige LAS TRES condiciones (clearance CV + alta de fisio DRA + pines de seguridad probados con carga). El fisio de DRA es la respuesta definitiva; esto no la reemplaza." },
  { name: "Prensa de Piernas (o Extensión de Rodilla) — día PESADO", sets: 3, reps: "10-12", tempo: "RIR 2", rest: "90", yt: "leg press machine form", notes: "Tu mejor compuesto de pierna CARGABLE y gate-safe con la barra limitada: espalda apoyada, SIN carga axial en la columna, seguro en solitario (contrapeso). Día PESADO de cuádriceps (tu eslabón más frágil; el sábado compensa ligero): semanas 1-2 de la re-entrada a RIR 3 con carga conocida, RIR 2 desde la 3ª, exhala al empujar, SIN Valsalva y sin bajar tan profundo que la pelvis se enrolle (gate DRA); chequeo de coning. Alternativa de aislamiento: extensión de rodilla 12-15 RIR 1-2. Dolor anterior de rodilla → menos rango, no suspendas." },
  { name: "Pantorrillas en Prensa (calf press)", sets: 3, reps: "10-15", tempo: "RIR 2", rest: "45", yt: "leg press calf raise form", notes: "En la MISMA prensa, sin montaje extra: pies bajos en la placa, empuja con el antepié, pausa arriba y estiramiento abajo controlado. Exhala al empujar, sin apnea. Dosis PRINCIPAL de pantorrilla acá a propósito: queda a ~60h de la tirada del domingo (el DOMS inicial no la pisa) y protege aquiles/tibial para el 10K. La 2ª exposición del sábado es SUAVE y se elimina si las pantorrillas amanecen cargadas algún domingo." },
  { name: "Hip Thrust a 1 pierna (o bipodal con pausa)", sets: 3, reps: "8-12", tempo: "Pausa arriba · RIR 3", rest: "90", yt: "single leg hip thrust form", notes: "Cadena posterior segura, autolimitante en carga, sin bisagra de pie. NO peso muerto. Sin apnea. TECHO RIR≥2-3 y chequeo de coning/doming en CADA serie (DRA no valorada); si aparece abombamiento, pesadez pélvica o escape, baja carga o suspende. Si la unilateral pierde técnica, bipodal con pausa de 2s." },
  { name: "Isquios Excéntrico ASISTIDO (Nordic) — dosis de TRANSICIÓN", sets: 1, reps: "2-3", tempo: "Excéntrico lento", rest: "90", yt: "assisted eccentric nordic hamstring lower", notes: "AL FINAL de la pierna y ÚNICO excéntrico fuerte de la semana. OJO: la tirada es el DOMINGO A LA MAÑANA → margen real ~60h, por eso la dosis se queda en 1x2-3 MÍNIMO 3 semanas. Sube a 1x4 (y luego 1x5) SOLO tras 2 domingos seguidos con isquios limpios (≤2/10 al despertar el sábado y zancada normal el domingo). Si 2 semanas seguidas el DOMS altera la zancada → múdalo al final del MARTES (~108h de margen). Rodillas en colchoneta, tobillos anclados firmes (base de la máquina o KBs pesadas — PRUEBA el anclaje SIN carga primero), exhala toda la bajada, manos listas para recibirte. Regla dura: nunca a <60h de la tirada." }
];

// BLOQUE C — SÁBADO día: la sesión COMPLETA (sin tope de tiempo) — valle d2: fueling líquido previo INNEGOCIABLE — OBLIGATORIA
// Orden: los primeros 7 + core = INNEGOCIABLES (aislados de bajo costo sistémico, van aun en valle) · los marcados BONUS solo si el fueling entró y el test del habla pasa.
const BLOCK_C = [
  { name: "Prensa o Extensión de Cuádriceps — día LIGERO", sets: 3, reps: "12-15", tempo: "RIR 3", rest: "75", yt: "light leg press or leg extension form", notes: "SÍ tenés prensa (la 'plancha' sentado con contrapeso): usala LIVIANA, o la extensión de rodilla — lo que sientas mejor. Día LIGERO a propósito: carga menor que el JUEVES, RIR 3, exhala al empujar/extender, sin énfasis excéntrico (cuádriceps otra vez a ~40h del jueves, y la tirada es MAÑANA a la mañana — NUNCA pesada). En la prensa: espalda apoyada, exhala al empujar, SIN Valsalva y sin bajar tan profundo que la pelvis se enrolle (gate DRA). Si llegás con DOMS palpable de cuádriceps, baja a 2 series." },
  { name: "Puente de Isquios con Pies en Banco (2 piernas, pausa)", sets: 3, reps: "12-15", tempo: "Pausa 2s arriba", rest: "75", yt: "feet elevated hamstring bridge bench form", notes: "Sustituto SIN máquina de curl femoral (tu estación de pierna solo EXTIENDE, no flexiona) y SIN peso que caiga: talones sobre el banco a baja altura, piernas casi extendidas (palanca larga = sesga ISQUIO, no glúteo). Sube la cadera con los isquios —no con la lumbar— y pausa 2s arriba; baja controlado. Peso corporal, RIR 2-3, exhala al subir, sin apnea, chequea coning/doming en cada serie. Concéntrico/isométrico: no apila DOMS sobre el Nordic del jueves ni roba el valle. UPGRADE (si confirmás banda elástica): Curl Femoral Tumbado con Banda al tobillo — flexión de rodilla REAL, retorno suave sin excéntrico." },
  { name: "Press Inclinado Alto con Mancuernas (70-75°)", sets: 3, reps: "10", tempo: "RIR 2", rest: "75", yt: "high incline dumbbell press 75 degrees", notes: "2ª exposición EFECTIVA de empuje vertical, ángulo DISTINTO al press militar 90° del martes. Respaldo fijado a 70-75° (a ese ángulo computa como vertical), espalda SIEMPRE apoyada por la DRA, exhala al empujar, sin arquear la lumbar, RIR 2 real (valle d2: con el fueling previo hecho). Nada de series al fallo hoy: el costo se paga en el valle con ingesta baja. Ante abombamiento o pesadez pélvica, baja carga o suspende." },
  { name: "Elevaciones Laterales con Mancuernas", sets: 3, reps: "12-15", tempo: "RIR 2", rest: "45", yt: "dumbbell lateral raise form", notes: "La cabeza del hombro que FALTABA (los presses cargan la anterior; la lateral es la que da amplitud y sensación de hombro trabajado). Ligeras, sin balanceo, codos suaves, sube hasta la horizontal exhalando. Sentado en el banco si aparece doming o tentación de impulso lumbar." },
  { name: "Curl en Predicador con Mancuerna", sets: 3, reps: "10-12", tempo: "RIR 2", rest: "60", yt: "single arm dumbbell preacher curl form", notes: "Tu banco tiene atril de predicador: úsalo — curl estricto, sin ayuda del tronco (DRA-amable por diseño). Un brazo por vez, exhala al subir, bajada controlada de 2s. Alternativa: curl con barra Z en polea baja. 2ª exposición semanal de bíceps (la 1ª fue el martes)." },
  { name: "Tríceps en Polea con Cuerda", sets: 3, reps: "10-12", tempo: "RIR 2", rest: "60", yt: "rope triceps pushdown form", notes: "Codos pegados, separa la cuerda abajo, exhala al extender, torso vertical sin volcarse encima. 2ª exposición semanal de tríceps. Costo sistémico casi nulo: va aun en valle." },
  { name: "Pantorrilla de Pie con Kettlebell — SUAVE", sets: 2, reps: "15", tempo: "RIR 4", rest: "45", yt: "standing calf raise kettlebell form", notes: "2ª exposición de pantorrilla, deliberadamente SUAVE (RIR 4) las primeras 3 semanas: la tirada es MAÑANA a la mañana y el DOMS de pantorrilla nueva es riesgo para el aquiles. REGLA DURA: si las pantorrillas amanecen cargadas algún domingo, este slot se ELIMINA y queda solo el calf press del jueves. KB en una mano, la otra de apoyo, rango completo con pausa arriba." },
  { name: "Press Banca con Mancuernas — BONUS", sets: 3, reps: "8-12", tempo: "RIR 2", rest: "90", yt: "dumbbell bench press flat form", notes: "BONUS del sábado: solo si el fueling previo entró completo y el test del habla pasa — si no, se salta sin culpa (los innegociables ya se hicieron). MANCUERNAS a propósito: se pueden soltar al fallar. NUNCA banca con barra libre en solitario sin pines ni ayudante. Mancuernas a las rodillas y kick-back para posicionarte, exhala al empujar, escápulas atrás." },
  { name: "Superserie: Jalón Barra Z Supino ⇄ Remo en Polea — BONUS", sets: 4, reps: "8-12", tempo: "RIR 2", rest: "90", yt: "underhand ez bar lat pulldown seated cable row", notes: "BONUS del sábado (2ª frecuencia de tracción; agarre supino con barra Z, distinto al ancho del martes). Jalón y remo espalda con espalda, 90s al cerrar la pareja, exhala en cada tirón, torso quieto, chequeo de coning. Test del habla: si no podés hablar en frases completas, pasá a series simples o cerrá acá. Si 2 sábados seguidos no salen los BONUS, la superserie vuelve repartida al martes." },
  { name: "Mariposa / Aperturas (Pec Deck) — BONUS", sets: 2, reps: "12", tempo: "RIR 2", rest: "60", yt: "pec deck fly machine form", notes: "Último BONUS y PRIMER recorte del sábado: aislamiento sin carga axial para cerrar, exhala al juntar, sin apnea. Sin fallo: el costo se paga en el valle con ingesta baja." }
];
...
const CORE_DRA_JUEVES = [
  ...
  { name: "Respiración Diafragmática 360°", sets: 1, reps: "8-10 resp.", rest: "45", yt: "360 diaphragmatic breathing core", notes: "Cierre PARASIMPÁTICO deliberado: baja la activación antes de la cena, el CPAP y la inyección. Sin contracciones máximas de suelo pélvico hasta valoración del fisio." }
];

const CORE_DRA_SABADO = [
  { name: "Pallof Press en Polea", sets: 2, reps: "12/lado", rest: "45", yt: "pallof press cable anti rotation", notes: "Anti-rotación, DRA-safe." },
  { name: "Plancha SIN doming (inclinada o de rodillas)", sets: 3, reps: "20-30 seg", rest: "45", yt: "incline plank diastasis safe form", notes: "Relocada del día de pierna al sábado (más tiempo y sin inyección esa noche). Progresa a plancha completa SOLO si la línea alba controla la presión (valoración del fisio). Al PRIMER doming → inclinada con manos en banco. Respira todo el tiempo; una plancha en apnea no cuenta." }
];

// ACCESORIOS — LUNES mañana (tras la recuperación activa): isquios ligero + salud de hombro + extra opcional
const ACCESORIOS_LUNES = [
  { name: "Puente de Isquios a 1 Pierna (palanca larga)", sets: 3, reps: "12/pierna", rest: "60", yt: "single leg glute bridge long lever hamstring", notes: "SIEMPRE después del cardio suave, nunca antes. De verdad LIGERO y casi sin excéntrico: sube con UNA pierna exhalando y baja con DOS (elimina el excéntrico residual), RIR 3-4, cero fallo — la tirada fue AYER y el jueves viene la pierna: este slot no debe dejar rastro. Talones LEJOS del glúteo (sesga isquio), supino = mínima presión sobre la línea alba, sin apretar el suelo pélvico al máximo, chequea coning. El lunes es recuperación: si amaneces vacío, se salta sin culpa." },
  { name: "Face Pull con Cuerda en Polea Alta", sets: 2, reps: "15", rest: "45", yt: "rope face pull form external rotation", notes: "Cuerda a la cara separando los extremos al final (rotación externa). Ligero, torso vertical, exhala al tirar: salud de hombro que protege los tres presses de la semana. Costo de recuperación cero." },
  { name: "Elevaciones Laterales — EXTRA opcional", sets: 2, reps: "12-15", rest: "45", yt: "dumbbell lateral raise form", notes: "Solo si la energía sobra: exposición extra de deltoides lateral, ligera y sin balanceo. La dosis principal vive el sábado — este slot es 100% prescindible." }
];
...
const SCHEDULE = [
  { day: "Lunes", type: "Recuperación activa (MAÑANA): caminata rápida o bici suave + accesorios · OPCIONAL", target: "Fusible #1 del contrato de adherencia: mover el cuerpo sin costo de recuperación, a ~24h de la tirada. NUNCA carrera (sería impacto consecutivo con el domingo). El lunes solo hay ventana de MAÑANA.", time: "20-30 min + accesorios · AM", isBike: true, zone: "Z1-Z2 muy suave, 100% conversacional", duration: "20-30 min. Por defecto caminata rápida; bici suave si preferís pedalear. Mínima viable: 15' — cuenta como cumplido.", notes: "OPCIONAL: si amaneces vacío se salta SIN CULPA y la semana sigue perfecta (los obligatorios son Mar/Jue/Sáb/Dom). No en ayunas: 20-30 g de carbohidrato 20-30 min antes (un desayuno líquido sirve). Los accesorios van DESPUÉS del cardio suave.", accessories: ACCESORIOS_LUNES },
  { day: "Martes", type: "Fuerza — BLOCK_A (NOCHE ≤60'): superior + bisagra + brazos · OBLIGATORIA", target: "1ª sesión obligatoria de la semana. Pares antagonistas con descanso compartido para caber en 60 min sin recortar dosis. Empuje supino SOLO mancuernas/máquina; hip thrust con techo RIR3, exhalación sin apnea y chequeo de coning por serie.", time: "~55-60 min · 19:00-20:30 aprox · cerrar ≥2h antes de la cama", exercises: BLOCK_A, hasWarmup: true, coreDRA: CORE_DRA_MARTES },
  { day: "Miércoles", type: "Carrera Z2 corta (NOCHE) — 2ª exposición del 10K · OPCIONAL (promover a fija en 3-4 sem)", target: "Carrera suave la víspera de pierna (patrón ya probado en este plan). Espaciado de impacto ideal: tirada Dom mañana → Mié noche ≈ 3,5 días → Dom siguiente ≈ 3,5 días.", time: "~25-35 min + calentamiento · PM", isRunning: true, zone: "Z2 puro conversacional por FC (tope práctico 135-138 lpm + test del habla); Z3 SOLO tras clearance CV", duration: "25-35 min (semanas 1-2: run-walk 4'/1' × 6 si llevás >3 semanas sin correr regular). Rampa total de carrera ≤10%/sem. Mínima viable: 15'.", notes: "FUELING NOCTURNO ANTES aunque no haya hambre (intervención #1 contra la desgana): 30-50 g de carbohidrato + 20-25 g de proteína líquidos 45-60 min antes (leche + banano + whey). ALTERNATIVA del día: BICI EN LA CALLE — solo ruta iluminada y conocida, luces delantera/trasera y algo reflectivo; si el clima o la hora no acompañan → caminata rápida. Si casi no comiste en el día: acorta a 25', no la saltes." },
  { day: "Jueves", type: "Fuerza — BLOCK_B PIERNA (NOCHE ≤60') → INYECCIÓN al acostarse · OBLIGATORIA", target: "Pierna completa: goblet + prensa + calf press + Nordic en dosis de transición. Secuencia de la noche: entrenar 19:00-20:30 → cena normal post-entreno → CPAP y PINCHAZO al acostarte (22:30-23:00). Sin regla de separación con la comida; la 1ª semana vigilá si hay náusea nocturna que fragmente el sueño (plan B: mover el pinchazo a viernes AM).", time: "~55-60 min · 19:00-20:30 → cama 22:30-23:00", exercises: BLOCK_B, hasWarmup: true, coreDRA: CORE_DRA_JUEVES },
  { day: "Viernes", type: "Descanso TOTAL — valle día 1 + día crítico de proteína", target: "Recuperación completa en las primeras 24h post-dosis (pico de efecto GI) y blindaje del objetivo proteico en el peor día de apetito. NO es día de fuerza: el 4º día se GANA con 4 semanas de adherencia ≥80%, y aun entonces iría el lunes, jamás acá.", time: "0-20 min opcional", isRest: true, notes: "Sin entrenamiento estructurado. Opcional: caminata fácil 20-30 min + respiración diafragmática suave (DRA-safe). Cumplir al menos el PISO de proteína (1.8 g/kg ≈ 134 g) pese a la supresión de apetito, con formatos líquidos de baja saciedad mecánica (batido leche+yogur griego+fruta, huevos, atún, cottage) ANCLADOS POR RELOJ, no por hambre. 'Kit del viernes' preparado el jueves. Hidratación por horario (sed suprimida). Priorizar sueño con CPAP." },
  { day: "Sábado", type: "Fuerza — BLOCK_C COMPLETA (DÍA, sin tope de tiempo) · OBLIGATORIA", target: "La sesión más completa de la semana, en el día con más tiempo. Valle día 2: el FUELING LÍQUIDO PREVIO (45-60 min antes) es INNEGOCIABLE; ritmo tranquilo, descansos completos. Innegociables primero (cuádriceps ligero, isquios, inclinado, brazos, laterales, pantorrilla suave, core); los BONUS (banca, superserie Z, pec-deck) solo si el combustible entró y el test del habla pasa.", time: "~70-90 min · mañana o mediodía, con calma", exercises: BLOCK_C, hasWarmup: true, coreDRA: CORE_DRA_SABADO },
  { day: "Domingo", type: "Carrera Z2 — tirada del 10K (MAÑANA) · OBLIGATORIA · RESET de rampa", target: "Sesión aeróbica principal, reiniciada tras las semanas de inconsistencia: el tejido destolera antes que el sistema aeróbico. Vuelve a 60 min hacia la semana 7-8 si cada escalón sale limpio.", time: "30-35 min (reset) → hasta 60 min · AM", isRunning: true, zone: "Z2 por FC, conversacional, sin fueling intra (<75 min no lo justifica)", duration: "RESET: 30-35 min semanas 1-2 → rampa ≤10%/sem (35' → 40' → 45' → 50' → 55' → 60' tope). Subir escalón SOLO con cero dolor tendinoso >24h post y deriva cardíaca <5% en la 2ª mitad. NUNCA superar 60 min hasta clearance CV.", notes: "CHECK ORTOSTÁTICO como GATE (día ~3 post-dosis): de pie 1 min — ΔFC >20 lpm o mareo → la tirada se convierte en bici Z2 fácil o caminata. Hidratación: 500-750 ml + electrolitos el sábado noche y 300-500 ml antes de salir. 20-30 g de carbohidrato previo, no en ayunas. Cadencia ≥170 ppm, terreno llano. ISQUIOS: si el Nordic del jueves dejó rastro y la zancada no es normal → bici/caminata y el Nordic baja de dosis (regla escrita en su slot)." }
];
...
const COACH_SYSTEM_PROMPT = `Eres el coach de Falcon44+ para Pedro (44 años, MÉDICO de profesión — háblale como a un colega clínico: preciso y directo, con terminología médica cuando aplique, sin lenguaje alarmista de lego; aun así NO diagnostiques ni prescribas por él, él decide su propio manejo médico), acompañándolo en un plan de entrenamiento rediseñado que corre en paralelo a su tratamiento con tirzepatida (Mounjaro, inyección semanal el JUEVES AL ACOSTARSE, tras entrenar y cenar) y a dos objetivos: preservar masa magra y completar un 10K. Tu rol es guiar día a día, adaptar la sesión escrita a cómo llega Pedro esa mañana, y recordar límites de seguridad — nunca sustituyes al médico prescriptor, al fisioterapeuta de diástasis (DRA)/suelo pélvico ni el clearance cardiovascular.

FILOSOFÍA DEL PLAN (reprogramado ago-2026) — LA ADHERENCIA MANDA:
Con la desgana de entrenar bajo tirzepatida 5 mg (sospechoso principal: SUBFUELING crónico por supresión de apetito, no "falta de voluntad"), el plan se reprogramó alrededor de una sola métrica: APARECER. Entrena de NOCHE lunes a viernes (quita la batalla de voluntad matinal) y de DÍA el fin de semana. El contrato es 4 OBLIGATORIOS (fuerza Mar/Jue/Sáb + tirada Dom) y 2 OPCIONALES (Lun mañana recuperación activa, Mié noche carrera corta) — éxito semanal = 4/4, la sesión MÍNIMA VIABLE cuenta como cumplida, y rige la regla de los 10 minutos (cambiarse + 10 min del primer ejercicio, con permiso explícito de parar ahí, sin culpa). El valle de APETITO del fármaco (días 1-2 post-inyección = viernes-sábado) se cubre así: viernes descanso total, sábado se entrena IGUAL pero con fueling líquido previo innegociable y los BONUS recortables. Nunca conviertas los opcionales en fuente de culpa: existen para sumar, no para fallar.

ESTRUCTURA SEMANAL (reprogramada ago-2026 — referencia rápida, ver SCHEDULE para el detalle exacto):
- Lunes (MAÑANA, OPCIONAL): recuperación activa 20-30' — caminata rápida o bici suave + accesorios ligeros (puente de isquios 1p, face pull, laterales extra). NUNCA carrera (la tirada fue ayer). Mínima viable: caminata 15'.
- Martes (NOCHE, OBLIGATORIA, ≤60'): fuerza BLOCK_A — superior en pares antagonistas + hip thrust (techo RIR3) + superserie de brazos (curl Z ⇄ tríceps cuerda). Empuje supino SOLO mancuernas/máquina.
- Miércoles (NOCHE, OPCIONAL): carrera Z2 corta 25-35' (2ª exposición del 10K; run-walk las semanas 1-2). Alternativa: bici en la calle (solo ruta iluminada y conocida, con luces) o caminata rápida. Fueling líquido previo aunque no haya hambre.
- Jueves (NOCHE, OBLIGATORIA, ≤60'): fuerza BLOCK_B PIERNA — goblet/barra ligera + prensa + calf press + hip thrust 1p + Nordic en dosis de TRANSICIÓN (1x2-3). Secuencia: entrenar 19:00-20:30 → cena normal → INYECCIÓN al acostarse.
- Viernes: descanso TOTAL garantizado (valle día 1, pico de efecto GI); día crítico de proteína — piso 1.8 g/kg (~134 g) con líquidos anclados por reloj. NO es día de fuerza y no se negocia.
- Sábado (DÍA, OBLIGATORIA, sin tope): fuerza BLOCK_C completa — cuádriceps ligero, isquios, inclinado, brazos/laterales/pantorrilla + BONUS (banca, superserie Z, pec-deck) SOLO si el fueling líquido previo entró. Valle día 2: ritmo tranquilo, cero fallo.
- Domingo (MAÑANA, OBLIGATORIA): tirada Z2 del 10K EN RESET — 30-35' las semanas 1-2, rampa ≤10%/sem hasta 60' (sem 7-8). Check ortostático como gate; si el Nordic dejó rastro en los isquios → bici/caminata.
...
El viernes se ESPERA una lectura baja (día 1 post-dosis) — descanso duro, no es un fallo. El sábado puede amanecer regular: la sesión va IGUAL con el fueling líquido previo, recortando primero los BONUS. Nunca le digas a Pedro que "recupere" el domingo cargando de más lo que se perdió en el valle.
...
Objetivo 2.0-2.2 g/kg/día (155-170 g) TODOS los días, con 1.8 g/kg (140 g) como PISO de día malo (no como centro), en 4 tomas de 38-45 g — banda alta porque en déficit + GLP-1 + >40 años el extremo bajo se queda corto justo donde el fármaco más amenaza la ingesta. La síntesis de proteína muscular es AGUDA: comer 200 g el jueves no compensa un déficit el viernes, así que CADA día debe alcanzar su propio mínimo. Lunes-jueves (ingesta media a pico): apunta al objetivo pleno 1.8-2.2 g/kg, con carbohidrato peri-entreno el jueves (pierna) y el miércoles (carrera); las sesiones entre semana son NOCTURNAS: fueling líquido 45-60 min antes (30-50 g de carbohidrato + 20-25 g de proteína, p. ej. leche + banano + whey) AUNQUE NO HAYA HAMBRE — el subfueling es el sospechoso #1 de la desgana. Viernes-sábado (valle, saciedad baja por el GLP-1): estrategia "proteína primero" en formatos líquidos o blandos (whey isolate, skyr, yogur griego, requesón, batidos, caldos/sopas fortificadas) en tomas pequeñas y frecuentes, apuntando lo más alto tolerable hacia 2.0 g/kg (piso 1.8); sé honesto si la náusea no lo permite — el objetivo es MINIMIZAR el déficit, no fingir que desaparece. Hidratación + electrolitos proactivos TODOS los días del valle (no solo el sábado), más fibra y líquido para el estreñimiento del fármaco. Domingo (carrera Z2 de 45-60 min): 20-30 g de carbohidrato antes, no en ayunas; sin fueling intra (menos de 75 min no lo justifica). Regla transversal: separa las comidas sólidas ≥2-3h de las sesiones con brace y de correr, y recomienda una cena ligera y temprana antes del CPAP (el reflujo nocturno fragmenta el sueño y empeora la apnea). El timing/reparto de comidas es secundario al total diario — no generes ansiedad por el "momento perfecto". La hipoglucemia es un riesgo BAJO en monoterapia con tirzepatida (efecto insulinotrópico glucosa-dependiente), pero igual recomienda llevar carbohidrato de acción rápida en toda sesión aeróbica.

EL JUEVES Y LA INYECCIÓN DE MOUNJARO (secuencia ago-2026):
La noche del jueves es: entrenar pierna 19:00-20:30 → cena NORMAL post-entreno → CPAP y pinchazo AL ACOSTARSE (22:30-23:00). La tirzepatida subcutánea NO tiene requisito horario respecto a las comidas — no inventes reglas de separación cena-pinchazo ni exijas terminar horas antes: la única regla dura es cerrar la fuerza ≥2h antes de la cama. La 1ª semana pregúntale si la inyección nocturna le fragmentó el sueño con náusea; si pasa 2 noches, el plan B acordado es mover el pinchazo al VIERNES por la mañana (conserva el valle en vie-sáb) — decisión de Pedro con su prescriptor, no tuya.

SUEÑO Y CPAP:
El sueño es una palanca que se protege, no se negocia: si una sesión (sobre todo de fuerza en la tarde/noche) amenaza las 7 horas de sueño con CPAP, gana el sueño — termina la fuerza al menos 2 horas antes de acostarse (para Z2 suave basta 1-1.5h); si el margen no da, se RECORTA la sesión — jamás el sueño (una mínima viable de 25' + dormir completo le gana siempre a 60' + 5.5h). Nada de sesiones a las 4 AM. A medida que Pedro pierda peso, recuérdale retitular el CPAP con su especialista del sueño (la anatomía de la vía aérea superior cambia).

JERARQUÍA REALISTA DE OBJETIVOS bajo déficit calórico — sé honesto con Pedro sobre esto:
1) pérdida de grasa, 2) preservación (no ganancia) de masa magra, 3) "terminar" el 10K. El rendimiento de resistencia y la subida de testosterona son resultados SECUNDARIOS, no garantizados: no se pueden maximizar los cuatro frentes a la vez en déficit. La testosterona puede subir de forma modesta, pero sobre todo por la pérdida de grasa que produce el fármaco (vía SHBG), no por el entrenamiento en sí; el sueño protegido previene una CAÍDA de testosterona, no la sube por encima de su basal.

CARRERA HACIA EL 10K:
Dosis mínima eficaz, cero volumen extra, con rampa de impacto y salvaguardas post-dosis. FRECUENCIA Y VOLUMEN: 2 exposiciones de carrera Z2/semana. Miércoles (noche): Z2 corta (25-35 min). Domingo (mañana): tirada del 10K — EN RESET ago-2026 tras las semanas de inconsistencia: 30-35 min y rampa ≤10%/sem hasta 60 min (semana 7-8); el tejido destolera antes que el sistema aeróbico. Volumen total ~10-14 km/semana, suficiente para correr un 10K en Z2-Z3 baja sin robar recuperación a la fuerza. Se corre SIEMPRE por FC con banda, en Z2 conversacional estricto, superficie llana. RAMPA DE IMPACTO (corrige el patrón real de Pedro de ~0.5x/semana a 2x): semanas 1-2 mantener SOLO la carrera del domingo (y run-walk si lleva >3 semanas sin correr regular); añadir la 2ª carrera (miércoles) desde la semana 3; incremento de volumen de carrera ≤10%/semana. La 2ª carrera es SUSTITUIBLE por bici o marcha rápida si aparece molestia articular (tibial/aquíleo/fascia). Justificación: hueso y tendón adaptan por detrás del sistema cardiovascular; cuadruplicar el impacto de golpe en un IMC 26.6, >40 años, con SAHOS, es la vía directa a la lesión por sobrecarga. BICI (ago-2026): ya no es "solo finde" — es la ALTERNATIVA de la carrera del miércoles (en la calle SOLO con ruta iluminada y conocida, luces delantera/trasera y algo reflectivo) y la opción del lunes por la mañana (recuperación activa suave). El sábado ya NO es día de bici: es la fuerza completa. SALVAGUARDA HEMODINÁMICA: antes de TODO aeróbico de fin de semana (ventana ~48-72h post-dosis, con sed suprimida por el GLP-1 + SAHOS) → check de síntomas ortostáticos, precarga de hidratación con sodio, parada DURA ante mareo o presíncope. PROHIBIDO hasta el clearance cardiovascular: intervalos, series de velocidad, umbral, y toda tirada >60 minutos o progresión a 16-18 km. NO se promete un tiempo objetivo: la predicción de Garmin (~70 min para el 10K) es una estimación, no una meta comprometida; el rendimiento NO es prioridad y no se fuerza en déficit — los tiempos mejorarán sobre todo por la pérdida de peso y llegarán en mantenimiento.
            ...
            <div className="bg-slate-900 rounded-[35px] sm:rounded-[45px] p-6 sm:p-7 text-white shadow-xl relative overflow-hidden border border-slate-800 ring-1 ring-white/5">
              ...
              <div className="relative z-10 flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-[13px] sm:text-[15px] font-black leading-snug text-slate-100 uppercase tracking-tight italic">Noche L-V · día S-D. Obligatorios: Mar·Jue·Sáb fuerza + Dom tirada (4/4).<br /><span className="text-slate-400 font-bold lowercase text-[11px] sm:text-[12px] opacity-90 tracking-normal">la mínima viable cuenta. jueves: entrena → cena → inyección al acostarte. viernes descanso total. sábado con fueling previo.</span></p>
                </div>
              </div>
            </div>
