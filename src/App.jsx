...
// ========================================================================
// DATA MASTER — PLAN REDISEÑADO (full-body 3x + cardio dosis mínima hacia el 10K, sincronizado con Mounjaro)
// Perfil: Pedro Falcón, MÉDICO de profesión · 44 años, 77 kg (bajando desde 84), 170 cm, IMC 26.6, ICC 0.98; perímetros en seguimiento mensual, objetivo cintura <90 cm.
// Composición estimada (antropometría Navy, no DEXA): ~20% grasa / ~62 kg masa magra. FOCO: PRESERVAR esa masa magra (no aumentarla) — la pérdida de grasa la produce el déficit + tirzepatide, no el entrenamiento.
// Clínica: SAHOS severa (IAH residual 0.1-1.6 con CPAP), DRA no valorada aún por fisio, ED ansiogénica.
// Tirzepatide (Mounjaro) 5 mg/sem, inyección Jue PM. Pérdida ~0.6%/sem (SANA, sostenible).
...
// Meta aeróbica: 10K (el 21K queda abandonado) — cardio Z2 dosis mínima, bici SOLO fin de semana, para no robar recuperación a la fuerza.
// Restricción lumbar RELATIVA: NO peso muerto; sentadilla con barra SOLO tras clearance CV + fisio DRA; press supino SOLO mancuernas/máquina hasta pines confirmados y probados con carga.
// ========================================================================
...
const BLOCK_A = [
  ...
  { name: "Hip Thrust con Mancuerna/KB en Cadera (2 piernas)", sets: 3, reps: "10-12", tempo: "Pausa 2s · RIR 3", rest: "75", yt: "dumbbell hip thrust on bench form", notes: "Ya no es solo ligero: mancuerna o kettlebell sobre la cadera con progresión — única sobrecarga de cadena posterior SIN bisagra cargada (peso muerto sigue PROHIBIDO por DRA). Exhala al subir, pausa arriba SIN apnea, chequeo de coning por serie; abombamiento o pesadez pélvica → suspender. RIR 3 y énfasis concéntrico: las piernas llegan frescas al martes. MÍNIMA VIABLE si el tiempo aprieta (60 min): Press de Pecho + Jalón + Dead Bug." }
];
...
const BLOCK_B = [
  ...
  { name: "Prensa de Piernas (o Extensión de Rodilla) — día PESADO", sets: 3, reps: "10-12", tempo: "RIR 2", rest: "90", yt: "leg press machine form", notes: "Tu mejor compuesto de pierna CARGABLE y gate-safe con la barra limitada: espalda apoyada, SIN carga axial en la columna, seguro en solitario (contrapeso). Día PESADO de cuádriceps (tu eslabón más frágil; el jueves compensa ligero): cargá de verdad dentro de RIR 2, exhala al empujar, SIN Valsalva y sin bajar tan profundo que la pelvis se enrolle (gate DRA); chequeo de coning. Alternativa de aislamiento: extensión de rodilla 12-15 RIR 1-2. Dolor anterior de rodilla → menos rango, no suspendas." },
  { name: "Jalón + Remo en Polea (superserie, barra Z supino)", sets: 4, reps: "8-12", tempo: "RIR 1-2", rest: "90", yt: "underhand ez bar lat pulldown seated cable row", notes: "2ª frecuencia de tracción. Agarre supino estrecho con barra Z HOY (distinto al ancho del lunes y al neutro del jueves). Jalón y remo espalda con espalda, 90s al cerrar la pareja. Exhala en cada tirón, torso quieto, chequeo de coning. Test del habla (sin clearance CV, es la carga cardiovascular más alta de la semana): si no podés hablar en frases completas al terminar la pareja, pasá a series simples." },
  { name: "Press Banca con Mancuernas", sets: 3, reps: "8-12", tempo: "RIR 2", rest: "90", yt: "dumbbell bench press flat form", notes: "MANCUERNAS a propósito: se pueden soltar al fallar. NUNCA press de banca con barra libre en solitario sin pines de seguridad ni ayudante (mismas 3 condiciones que la sentadilla). Mancuernas a las rodillas y kick-back para posicionarte, exhala al empujar, escápulas atrás." },
  { name: "Hip Thrust a 1 pierna (o bipodal con pausa)", sets: 3, reps: "8-12", tempo: "Pausa arriba", rest: "90", yt: "single leg hip thrust form", notes: "Cadena posterior segura, autolimitante en carga, sin bisagra de pie. NO peso muerto. Sin apnea. TECHO RIR≥2-3 y chequeo de coning/doming en CADA serie (DRA no valorada); si aparece abombamiento, pesadez pélvica o escape, baja carga o suspende. Si la unilateral pierde técnica, bipodal con pausa de 2s." },
  { name: "Isquios Excéntrico ASISTIDO (sustituto del Nordic)", sets: 1, reps: "3-5", tempo: "Excéntrico lento", rest: "90", yt: "assisted eccentric nordic hamstring lower", notes: "AL FINAL del día de pierna y ÚNICO excéntrico fuerte de la semana: el DOMS pica JUE-VIE (valle, descanso protegido) y caduca antes del domingo (~96h). Rodillas en colchoneta, tobillos anclados firmes (base de la máquina o KBs pesadas — PRUEBA el anclaje SIN carga primero), exhala toda la bajada, manos listas para recibirte. Progresión: 1x3-5 las primeras 3-4 semanas; a 2x3-4 SOLO tras 2 sábados seguidos sin DOMS residual. Semana de tirada tope: 1x3. NUNCA moverlo al jueves ni la víspera." }
];

// BLOQUE C — JUEVES: Full-Body de volumen efectivo en máquina/mancuerna (ANTES de la inyección de Mounjaro)
const BLOCK_C = [
  { name: "Prensa o Extensión de Cuádriceps — día LIGERO", sets: 3, reps: "12-15", tempo: "RIR 3", rest: "75", yt: "light leg press or leg extension form", notes: "SÍ tenés prensa (la 'plancha' sentado con contrapeso): usala LIVIANA, o la extensión de rodilla — lo que sientas mejor. Día LIGERO a propósito: carga menor que el miércoles, RIR 3, exhala al empujar/extender, sin énfasis excéntrico (hay cuádriceps otra vez a <24h del miércoles y esta noche te inyectás). En la prensa: espalda apoyada, exhala al empujar, SIN Valsalva y sin bajar tan profundo que la pelvis se enrolle (gate DRA). Si llegás con DOMS palpable de cuádriceps, baja a 2 series." },
  { name: "Puente de Isquios con Pies en Banco (2 piernas, pausa)", sets: 3, reps: "12-15", tempo: "Pausa 2s arriba", rest: "75", yt: "feet elevated hamstring bridge bench form", notes: "Sustituto SIN máquina de curl femoral (tu estación de pierna solo EXTIENDE, no flexiona) y SIN peso que caiga: talones sobre el banco a baja altura, piernas casi extendidas (palanca larga = sesga ISQUIO, no glúteo). Sube la cadera con los isquios —no con la lumbar— y pausa 2s arriba; baja controlado. Peso corporal, RIR 2-3, exhala al subir, sin apnea, chequea coning/doming en cada serie. Concéntrico/isométrico: no apila DOMS sobre el Nordic del miércoles ni roba el valle. UPGRADE (si confirmás banda elástica): Curl Femoral Tumbado con Banda al tobillo — flexión de rodilla REAL, retorno suave sin excéntrico." },
  { name: "Press Inclinado Alto con Mancuernas (70-75°)", sets: 3, reps: "10", tempo: "RIR 2", rest: "75", yt: "high incline dumbbell press 75 degrees", notes: "2ª exposición EFECTIVA de empuje vertical, ángulo DISTINTO al press militar 90° del lunes. Respaldo fijado a 70-75° (a ese ángulo computa como vertical), espalda SIEMPRE apoyada por la DRA, exhala al empujar, sin arquear la lumbar, RIR 2 real (día pre-inyección). Nada de series al fallo hoy: el costo se paga en el valle con ingesta baja. Ante abombamiento o pesadez pélvica, baja carga o suspende." },
  { name: "Jalón o Remo en Polea (agarre neutro con triángulo)", sets: 3, reps: "10-12", tempo: "RIR 2", rest: "75", yt: "neutral grip lat pulldown or cable row", notes: "Cierra tracción a 2x/semana efectivas. Agarre neutro HOY (tercer agarre de la semana). Torso casi vertical, exhala en cada tirón, sin balanceo (mismas notas anti-reclinación del lunes)." },
  { name: "Mariposa / Aperturas (Pec Deck)", sets: 2, reps: "12", tempo: "RIR 2", rest: "60", yt: "pec deck fly machine form", notes: "Aislamiento sin carga axial para cerrar; exhala al juntar, sin apnea. REGLA DURA: termina TODA la sesión ≥3-4h ANTES de inyectar; evita una comida proteica grande justo antes (empeora la náusea). Si el día viene apretado (60 min) o hay fatiga, este es el PRIMER slot del jueves que se recorta." }
];
...
const ACCESORIOS_MARTES = [
  { name: "Puente de Isquios a 1 Pierna (palanca larga)", sets: 3, reps: "12/pierna", rest: "60", yt: "single leg glute bridge long lever hamstring", notes: "SIEMPRE después de la carrera, nunca antes. De verdad LIGERO y casi sin excéntrico: sube con UNA pierna exhalando y baja con DOS (elimina el excéntrico residual), RIR 3-4, cero fallo — no debe robar nada al excéntrico del miércoles ni dejar DOMS. Dosis: carrera 25-35' → 3x12/pierna; carrera 40-45' → 2x10-12/pierna. Talones LEJOS del glúteo (sesga isquio), supino = mínima presión sobre la línea alba, sin apretar el suelo pélvico al máximo, chequea coning. El martes existe para la carrera, no para la fuerza." },
...
const SCHEDULE = [
  { day: "Lunes", type: "Fuerza — BLOCK_A (full-body: empuje horizontal/vertical + bisagra glútea)", target: "Estímulo de preservación de masa magra con máxima frescura tras el finde; densidad sobre duración (superseries antagonistas). Empuje supino SOLO con mancuernas o máquina (barra libre sobre el tórax vetada sin pines de seguridad confirmados y probados con carga); hip thrust con techo RIR≥2-3, exhalación sin apnea y chequeo de coning/doming por serie.", time: "~70-80 min · PM", exercises: BLOCK_A, hasWarmup: true, coreDRA: CORE_DRA_LUNES },
  { day: "Martes", type: "Carrera Z2 (exposición #1 del 10K) + accesorios ligeros", target: "Primera de dos exposiciones aeróbicas semanales orientadas al 10K, descargada para no comprometer BLOCK_B del miércoles.", time: "~35-50 min", isRunning: true, zone: "Z2 puro conversacional por FC con banda, superficie llana (Z3 SOLO tras clearance CV)", duration: "35-50 min. RAMPA DE IMPACTO: semanas 1-2 solo la carrera del domingo; esta 2ª carrera se añade desde la semana 3, incremento de volumen de carrera ≤10%/sem.", notes: "No en ayunas: 20-30 g de carbohidrato 30-45 min antes. Sustituible por bici o marcha rápida si aparece molestia articular (tibial/aquíleo/fascia).", accessories: ACCESORIOS_MARTES },
  { day: "Miércoles", type: "Fuerza — BLOCK_B (full-body: tracción + patrón sentadilla + cuádriceps gate-safe)", target: "Segunda frecuencia de tracción y el estímulo de cuádriceps que el gate médico sí permite — el eslabón más frágil de la preservación de masa magra (energía ALTA, ingesta ALTA).", time: "~75-85 min · PM", exercises: BLOCK_B, hasWarmup: true, coreDRA: CORE_DRA_MIERCOLES },
  { day: "Jueves", type: "Fuerza — BLOCK_C (máquina, volumen) — ANTES de la inyección PM", target: "Tercera dosis de volumen con mínima demanda axial/técnica/SNC, en el día de menor Body Battery.", time: "~55-65 min · terminar ≥3-4h antes de Mounjaro", exercises: BLOCK_C, hasWarmup: true, coreDRA: CORE_DRA_JUEVES },
  { day: "Viernes", type: "Descanso total #1 — día crítico de proteína", target: "Recuperación completa en las primeras 24h post-dosis (pico de efecto GI) y blindaje del objetivo proteico en el peor día de apetito.", time: "0-20 min opcional", isRest: true, notes: "Sin entrenamiento estructurado. Opcional: caminata fácil 20-30 min + respiración diafragmática suave (DRA-safe). Cumplir al menos el PISO de proteína (1.8 g/kg ≈ 140 g) pese a la supresión de apetito, con formatos de baja saciedad mecánica (batido leche+yogur griego+fruta, huevos, atún, cottage). 'Kit del viernes' preparado el jueves. Hidratación por horario (sed suprimida). Priorizar sueño con CPAP." },
  { day: "Sábado", type: "Descanso #2 por defecto / Bici Z2 OPCIONAL (solo fin de semana)", target: "Segundo día de recuperación real en déficit + GLP-1; si la readiness es alta, aeróbico placentero de bajo impacto (decisión firme de Pedro).", time: "0-90 min según readiness", isBike: true, zone: "Z2 por FC, terreno llano/rodado, conversacional, sin sprints ni subidas máximas", duration: "POR DEFECTO = descanso o caminata fácil. OPCIONAL = 45-90 min solo si Body Battery/ingesta/hidratación se recuperaron.", notes: "CHECK HEMODINÁMICO ANTES (ventana ~48h post-dosis): auto-síntomas ortostáticos, hidratación con sodio (pizca de sal + limón), parada DURA ante mareo/presíncope. Si Body Battery bajo o apetito/sed muy suprimidos → NO bici, descanso. Nunca bici larga el sábado Y carrera larga el domingo el mismo fin de semana." },
  { day: "Domingo", type: "Carrera Z2 'larga' del 10K (exposición #2, REEMPLAZA la tirada hacia el 21K) o autorregulada", target: "Sesión aeróbica principal de la semana, orientada al 10K — el bloque hacia el 21K queda abandonado.", time: "45-60 min MÁXIMO", isRunning: true, zone: "Z2 por FC, conversacional, sin fueling intra (<75 min no lo justifica)", duration: "45-60 min (~7-9 km al ritmo Z2 actual). Si el sábado hubo bici → recortar a 40-45 min. NUNCA superar 60 min ni progresar a 16-18 km hasta clearance CV.", notes: "CHECK hidratación/ortostático previo (ventana ~72h post-dosis). 20-30 g de carbohidrato previo, no en ayunas. Si Body Battery bajo o piernas cargadas → bici Z2 fácil o caminata + movilidad." }
];
...
- Lunes: full-body BLOCK_A (empuje horizontal/vertical + bisagra glútea) con máxima frescura tras el finde; el empuje supino va SOLO con mancuernas o máquina — la barra libre sobre el tórax queda vetada sin pines de seguridad confirmados y probados con carga; el hip thrust lleva techo RIR≥2-3, exhalación sin apnea y chequeo de coning/doming por serie.
- Martes: carrera Z2 (1ª exposición del 10K) + accesorios ligeros de isquios/hombro; la 2ª carrera semanal se introduce recién desde la semana 3 (rampa de impacto ≤10%/sem), nunca desde el arranque del bloque.
- Miércoles: full-body BLOCK_B — tracción + patrón sentadilla gate-safe (goblet/caja) + estímulo de CUÁDRICEPS (extensión de rodilla), el eslabón más frágil de la preservación de masa magra bajo el gate cardiovascular.
- Jueves: full-body BLOCK_C de volumen en máquina, SIEMPRE terminado ≥3-4h antes de la inyección de Mounjaro; la comida proteica principal va separada de la hora de acostarse.
- Viernes: descanso total garantizado #1 (pico de efecto GI); día crítico de proteína — cumplir al menos el piso de 1.8 g/kg pese a la supresión de apetito.
- Sábado: descanso #2 por defecto; bici Z2 OPCIONAL solo con readiness alta, precedida de un check hemodinámico/hidratación (ventana post-dosis).
- Domingo: carrera Z2 "larga" del 10K (45-60 min máximo, reemplaza la tirada hacia el 21K) o autorregulada según piernas/Body Battery; nunca bici larga el sábado y carrera larga el domingo el mismo fin de semana.
...
Dosis mínima eficaz, cero volumen extra, con rampa de impacto y salvaguardas post-dosis. FRECUENCIA Y VOLUMEN: 2 exposiciones de carrera Z2/semana. Martes: Z2 corta (35-50 min). Domingo: Z2 "larga" del 10K (45-60 min, tope 60 min). Volumen total ~10-14 km/semana, suficiente para correr un 10K en Z2-Z3 baja sin robar recuperación a la fuerza. Se corre SIEMPRE por FC con banda, en Z2 conversacional estricto, superficie llana. RAMPA DE IMPACTO (corrige el patrón real de Pedro de ~0.5x/semana a 2x): semanas 1-2 mantener SOLO la carrera del domingo; añadir la 2ª carrera (martes) desde la semana 3; incremento de volumen de carrera ≤10%/semana. La 2ª carrera es SUSTITUIBLE por bici o marcha rápida si aparece molestia articular (tibial/aquíleo/fascia). Justificación: hueso y tendón adaptan por detrás del sistema cardiovascular; cuadruplicar el impacto de golpe en un IMC 26.6, >40 años, con SAHOS, es la vía directa a la lesión por sobrecarga. BICI (decisión firme: SOLO fin de semana): sábado Z2 45-90 min OPCIONAL, de bajo impacto, buena para el ICC 0.98; NO es sesión clave. Si el sábado tocó bici larga, el domingo se recorta a 40-45 min. Nunca dos aeróbicos largos el mismo fin de semana. SALVAGUARDA HEMODINÁMICA: antes de TODO aeróbico de fin de semana (ventana ~48-72h post-dosis, con sed suprimida por el GLP-1 + SAHOS) → check de síntomas ortostáticos, precarga de hidratación con sodio, parada DURA ante mareo o presíncope. PROHIBIDO hasta el clearance cardiovascular: intervalos, series de velocidad, umbral, y toda tirada >60 minutos o progresión a 16-18 km. NO se promete un tiempo objetivo: la predicción de Garmin (~70 min para el 10K) es una estimación, no una meta comprometida; el rendimiento NO es prioridad y no se fuerza en déficit — los tiempos mejorarán sobre todo por la pérdida de peso y llegarán en mantenimiento.
          ...
          <div className="space-y-6 sm:space-y-8 animate-fade-in">
            ...
            <div className="bg-white border border-slate-100 rounded-[28px] p-5 shadow-sm">
              ...
              <div className="space-y-1.5 text-[11px] font-bold text-slate-600">
                ...
                <p><span className="text-sky-600 font-black">Meta 10K</span> (no 21K): 2 carreras Z2 fáciles/sem + bici solo el finde. Suficiente para el 10K sin robar recuperación a la fuerza.</p>
